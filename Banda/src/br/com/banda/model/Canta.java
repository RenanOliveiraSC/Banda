...
public class Canta extends Banda {
	...
	private int can_Banda;
	private int can_Musica;
	private int can_Gravadora;
	private int can_Estilo;
	...
	public int getCan_AnoGravacao() {
		return can_AnoGravacao;
	}

	public void setCan_AnoGravacao(int can_AnoGravacao) {
		this.can_AnoGravacao = can_AnoGravacao;
	}
